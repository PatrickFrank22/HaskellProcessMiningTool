...
module ParserApp.XesParserXmlConduit ( xesParserXmlConduit ) where
...
xesParserXmlConduit :: FilePath -> T.Text -> T.Text -> IO()
xesParserXmlConduit fileName selectedMiner threshold = do
